...
class UserModule extends CWebModule
{
	...
	public $registrationSocialUrl = array("/user/registrationsocial");
    ...
    /**
     * Retrieves a list of topics for autosuggestion.
     */
    public function userFilterByName($firstname = NULL)
    {
        $criteria = new CDbCriteria;
        $criteria->condition = 'firstname LIKE "%' . strtolower($firstname) . '%"';
        $user = Profile::model()->findAll($criteria);
        
        return $user;
    }

    /**
     * Retrieves user events
     */
    public function getUserEvents($uid = null, $start = null, $end = null)
    {
        return User::model()->getUserEvents($uid, $start, $end);
    }
